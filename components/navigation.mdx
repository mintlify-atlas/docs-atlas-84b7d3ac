...
These utility components enhance navigation and user interaction.

### BackLink

A back navigation link with an arrow icon, useful for detail pages.
...
```astro src/pages/project/[id].astro
---
...
<ParamField path="links" type="SocialLink[]" required>
  Array of social link objects with `href`, `icon`, and `label` properties.
</ParamField>

#### Usage

```astro src/components/navigation/Footer.astro
---
